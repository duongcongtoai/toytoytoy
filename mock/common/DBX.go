...
import (
	...
	common "github.com/duongcongtoai/toytoytoy/internal/common"
...
func (_m *DBX) Begin() (common.Tx, error) {
	ret := _m.Called()

	var r0 common.Tx
	if rf, ok := ret.Get(0).(func() common.Tx); ok {
		r0 = rf()
	} else {
		if ret.Get(0) != nil {
			r0 = ret.Get(0).(common.Tx)
		}
	}
...
func (_m *DBX) BeginTx(ctx context.Context, opts *sql.TxOptions) (common.Tx, error) {
	ret := _m.Called(ctx, opts)

	var r0 common.Tx
	if rf, ok := ret.Get(0).(func(context.Context, *sql.TxOptions) common.Tx); ok {
		r0 = rf(ctx, opts)
	} else {
		if ret.Get(0) != nil {
			r0 = ret.Get(0).(common.Tx)
